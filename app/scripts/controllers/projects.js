...
function ProjectsCtrl($scope, metaTagsService){
  ...
  $scope.allProjects = [
    ...
    },
    {
      ...
      category: 'ui-ux',
      name:'Interjet',
      projectDescription:'Desarrollamos y diseñamos un administrador de transportación terrestre en todo México para Interjet, el cual permite que los choferes vean -en tiempo real- la información sobre rutas y pasajeros. Asimismo, incluye un sistema de reportes de ingresos para el control de los mismos.',
      //url: 'https://www.bordercenter.net/',
    ...
    },
    {
      ...
      category: 'ui-ux',
      name:'Ascentec',
      projectDescription:'Empresa líder en el ramo de la tecnología vertical: ascensores, escaleras y rampas eléctricas, montacoches, montacamas. Realizamos el diseño y desarrollo web, mismo que incluye el catálogo de productos, formularios de contacto, descripciones y contenido audiovisual. La página web es ágil, responsive, y adaptada a diversos navegadores y plataformas.',
      //url: 'https://www.bordercenter.net/',
    ...
    },
    {
      ...
      category: 'branding',
      name:'TRIPBU',
      projectDescription:'Empresa dedicada a las rentas vacacionales. Tripbu administra las propiedades de diversas personas, y al mismo tiempo cuenta con un catálogo de rentas vacacionales para viajeros y turistas. Realizamos el branding completo para Tripbu: diseño de logo, gráficos, colores, catálogos, tarjetas de presentación, para diversas aplicaciones tanto impresas como digitales.',
      //url: 'https://www.bordercenter.net/',
    ...
    },
    {
      ...
      category: 'ui-ux',
      name:'DEZAIN',
      projectDescription:'Tienda de muebles de madera fina para el hogar y oficina. Realizamos el diseño y desarrollo web de la página, la cual cuenta con ecommerce mediante la integración con Shopify -una de las mejores plataformas de ecommerce del mundo, para procesamiento de pagos, registro de ventas y analíticas. La página web es responsive, ágil y compatible con todos los navegadores.',
      //url: 'https://www.bordercenter.net/',
    ...
    },
    {
      ...
      category: 'ui-ux',
      name:'MENT',
      projectDescription:'Marca de ropa deportiva personalizada. Realizamos el diseño de la página web y tienda en línea, misma que incluye el catálogo de productos, gestión de pagos y registro de ventas. La página web es responsive, ágil y compatible con todos los navegadores.',
      //url: 'https://www.bordercenter.net/',
    ...
    },
    {
      ...
      projectDescription:'Plataforma de participación ciudadana para transformar la educación. Desarrollamos un sitio web en el cual es posible buscar, comparar y calificar todas las escuelas de México.',
    ...
    },
    {
      ...
      category: 'ui-ux',
      name:'Airportcun',
      projectDescription:'Es un sitio web del aeropuerto de Cancún en la cual desarrollamos una plataforma dónde se pueden consultar vuelos en tiempo real, buscar transportación y tours en distintos destinos.',
    ...
    },
    {
      ...
      slug:'viajesclaros',
      category: 'ui-ux',
      projectDescription:'Es un proyecto del IFAI donde se manejan datos abiertos para mostrar los viajes y gastos de los servidores púbicos. Fuimos ganadores del 1er lugar en el desarrollo del sitio web el cual permite; buscar, comparar y accesar a dicha información.',
    ...
    },
    {
      ...
      slug:'consejosano',
      category: 'ui-ux',
      projectDescription:'Es una empresa líder en servicios de telemedicina para los Hispanos en los Estados Unidos. Implementamos un sitio web para atención y consultas médicas las 24 horas.',
    ...
    },
    {
      ...
      slug:'mr-gotcha',
      category: 'ui-ux',
      projectDescription:'Es el nuevo paintball de cancún, En este proyecto implementamos un sitio web el cual permite ver los paquetes y promociones así como visualizar la galería del campo de batalla y áreas de actividades, también se puede contactar y reservar directamente desde el sitio.',
    ...
    },
    {
      ...
      slug:'capshia',
      category: 'ui-ux',
      projectDescription:'Es una Marca de Moda y Accesorios creada por 2 diseñadoras Mexicanas, Diseñamos y desarrollamos la tienda en linea, la cual permite consultar y comprar la colección de temporada de la marca.',
    ...
    },
    {
      ...
      slug:'sea-walls',
      category: 'ui-ux',
      projectDescription:'Es un proyecto de arte urbano inovador creado por los miembros de PangeaSeed. Implementamos un sitio web para fomentar el apoyo de artistas internacionales para ayudar a plasmar la belleza de los océanos en las calles de todo el mundo a través del arte y el activismo.',
...

    {
      ...
      slug:'justiti',
      category: 'ui-ux',
      projectDescription:'Es un proyecto para facilitar el acceso a la justicia a los ciudadanos. Implementamos el diseño de la marca y desarrollamos un sitio web que permite fácilmente el acceso a la justicia, mediante la búsqueda orientación y mensajería legal a los ciudadanos.',
    ...
    },
    {
      ...
      category: 'ui-ux',
      projectDescription:'Es una marca de Jugos cold pressed y productos naturales. Implementamos diseño y solución e-commerce para la venta de jugos, productos y paquetes detox.',
    ...
    },
    {
      ...
      category: 'ui-ux',
      projectDescription:'Es un nuevo desarrollo inmobiliario en playa del Carmen que brinda a inversionistas nacionales y extranjeros la armonía entre naturaleza y planeación urbana. Desarrollamos un sitio web para consultar todo acerca del proyecto, desde la venta de lotes, galería y contacto.',
    ...
    },
    {
      ...
      slug:'caribemaya',
      category: 'ui-ux',
      projectDescription:'Compañía de administración de destinos turísticos, Desarrollamos un sitio web que ofrece servicios, traslados, actividades e información en diferentes destinos en Cancún y La Riviera Maya.',
    ...
    },
    {
      ...
      category: 'ui-ux',
      projectDescription:'Especialista en Decoración de Interiores para casa habitacional, en este proyecto logramos rediseñar su Logotipo y crear su sitio web.',
    ...
    },
    {
      ...
      slug:'water-tours',
      category: 'ui-ux',
      projectDescription:'Es una empresa dedicada a la venta de tours acuáticos, Creamos la marca desde cero e implementamos un sitio web en el cual se puede comprar y reservar una gran variedad de actividades acuáticas.',
    ...
    },
    {
      ...
      category: 'branding',
      projectDescription:'Creación de nombre e Identidad Corporativa para empresa que ofrece soluciones de energía sustentable.',
    ...
    },
    {
      ...
      slug:'travcy',
      category: 'branding',
      projectDescription:'Elección de nombre y diseño de logotipo para herramienta web desarrollada a la medida para la administración y control comercial para empresas turísticas.',
    ...
    },
    {
      ...
      slug:'travelite',
      category: 'branding',
      projectDescription:'Diseño de Logotipo para agencia de viajes especializada en experiencias premium para tarjetahabientes.',
    ...
    },
    {
      ...
      category: 'branding',
      projectDescription:'Es una empresa de transportación turistica del Aeropuerto. Creamos la marca y desarrollamos su sitio web.',
    ...
    },
    {
      ...
      slug:'bluecore',
      category: 'branding',
      projectDescription:'Es una organización (ONG) dedicada a generar una cultura de conservación marina. Contribuimos en el diseño y desarrollo de su sitio web.',
