...
function HomeCtrl($scope, $rootScope, blogService, metaTagsService, $timeout) {
  ...
  $scope.clients = [
    ...
    },
    {
      ...
      name: 'Ivonne Corona',
      company: 'VISITAX MEX',
      companyUrl: 'https://visitaxmex.com/',
      quote: 'Spaceship Labs nos ayudo a crear una plataforma personalizada para la recaudación del impuesto turístico Visitax Online. ¡Siempre estuvieron al pendiente para brindar soporte!'
    }
